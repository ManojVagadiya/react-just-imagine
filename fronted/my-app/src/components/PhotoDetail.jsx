        ...
        <div className="flex xl:flex-row flex-col m-auto bg-white" style={{ maxWidth: '1500px', borderRadius: '32px' }}>
          ...
          <div className="w-full p-5 flex-1 xl:min-w-620">
            <div className="flex items-center justify-between">
              ...
              <a href={photoDetail.destination} target="_blank" rel="noreferrer">
                {photoDetail.destination?.slice(8)}
              </a>
            </div>
            <div>
              ...
              <p className="mt-3">{photoDetail.about}</p>
            </div>
            <Link to={`/user-profile/${photoDetail?.postedBy_id}`} className="flex gap-2 mt-5 items-center bg-white rounded-lg ">
              <img src={photoDetail?.postedBy.image} className="w-10 h-10 rounded-full" alt="user-profile" />
